...
<%@page import="kr.co.sist.user.restarea.vo.FoodVO"%>
<%@page import="java.util.List"%>
<%@page import="kr.co.sist.user.restarea.vo.ReviewVO"%>
<%@page import="kr.co.sist.manager.restarea.dao.AddRestDAO"%>
<%@page import="kr.co.sist.user.restarea.dao.ReviewDAO"%>
<%@page import="kr.co.sist.user.restarea.dao.RestDAO"%>
...
/* 	            	alert(json.list[0].foodNm)
	            	...
	            	$.ajax({
	            		...
	            		method: 'post',
	            		data : "jsonArrayString="+jsonArrayString,
	            		dataType: 'json',
	            		error: function(xhr){
								...
								<div id="carouselFood" class="carousel slide" style="width: 1500px; height: 400px">
								  ...
								  <div class="carousel-inner">
								    ...
								    <div class="carousel-item active">
								      <div>
								      <img src="images/kj.png" style="width:200px; height:150px">
								      메뉴명:<%=fVO.getFoodName() %><br/>
								      가격:<%=fVO.getFoodPrice() %><br/>
								      설명:<%=fVO.getFoodDetail() %><br/>
								      </div>
								    </div>
